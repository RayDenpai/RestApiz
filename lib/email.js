    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Selamat Datang Di Rest-APIs Denpai</h3>
            <p>
...
Jika Kamu Memiliki Masalah, Silahkan Hubungin Saya Via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6283199346086">WhatsApp</a></span></span>
            <span style="display: block;"><br>By,<br>Denpai</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"Denpai" <admin@izuka.my.id>',
        to: email,
        subject: 'Verify Email - Api Denpai',
        html: inboxGmail,
      };
